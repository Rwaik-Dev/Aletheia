...
Alinhado ao [[Projetos/monitores/UI Desktop - Padrão Apex Clients|UI Desktop — padrão Apex Clients]]: pacote `ui/` (Sun Valley / `sv-ttk`), `app.py` como controller, shell header + chip Dev/Prod, abas Config / Execução / Logs.
